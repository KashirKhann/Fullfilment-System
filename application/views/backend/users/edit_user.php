                    ...
                    <form class="form" action="<?php echo base_url('administrator/update_customer_user');?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" placeholder="Enter your password" name="password" value="<?php echo $customer_user->password;?>" />
                                    <div class="input-group-append"></div>
                                </div>
                                <span class="form-text text-muted">Please enter your Zip Code</span>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                ...
                                <input type="hidden" name="customer_id" value="<?php echo $customer_user->id;?>">
                            </div>
                        </div>
                        <hr>
                        <div class="row">
