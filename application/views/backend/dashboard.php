					...
					<div class="subheader py-6 py-lg-8 subheader-transparent" id="kt_subheader">
						<div
							...
							<div class="d-flex align-items-center">
								<!--begin::Daterange-->
								<a href="#"
									class="btn btn-fixed-height btn-bg-white btn-text-dark-50 btn-hover-text-primary btn-icon-primary font-weight-bolder font-size-sm px-5 mr-3"
									id="kt_dashboard_daterangepicker" data-toggle="tooltip"
									title="Select dashboard daterange" data-placement="top">
								...
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-6">
											<h3 class="card-title">
												<span
													class="card-label font-weight-bolder font-size-h4 text-dark-75">Weekly
													Sales</span>
											</h3>
										...
										<!--begin::Body-->
										<div
											class="card-body d-flex align-items-center justify-content-between pt-7 flex-wrap">
											<!--begin::label-->
											<span class="font-weight-bolder display5 text-dark-75 py-4 pl-5 pr-10">
												<span
													class="font-weight-normal font-size-h6 text-muted pr-1">$</span>64M</span>
											<!--end::label-->
											<!--begin::Chart-->
											<div class="progress-vertical w-200px h-125px">
												<div class="progress bg-light-primary" data-toggle="tooltip"
													title="30%">
								...
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-6">
											<h3 class="card-title">
												<span
													class="card-label font-weight-bolder font-size-h4 text-dark-75">Technologies</span>
											</h3>
											<div class="card-toolbar">
												<div class="dropdown dropdown-inline" data-toggle="tooltip"
													title="Quick actions" data-placement="left">
										...
										<div
											...
											<!--begin::Label-->
											<span
												class="font-weight-bolder display5 text-dark-75 pl-5 pr-10">9.3M</span>
											<!--end::Label-->
											<!--begin::Visuals-->
											<div class="d-flex align-items-center justify-content-between">
												...
												<div class="d-flex flex-column mr-4">
													...
													<div class="legend d-flex align-items-center py-1">
														...
														<span
															class="font-weight-bolder font-size-lg text-muted">HTML</span>
													</div>
													<!--end::legend-->
													<!--begin::legend-->
													<div class="legend d-flex align-items-center py-1">
														...
														<span
															class="font-weight-bolder font-size-lg text-muted">CSS</span>
													</div>
													<!--end::legend-->
													<!--begin::legend-->
													<div class="legend d-flex align-items-center py-1">
														...
														<span
															class="font-weight-bolder font-size-lg text-muted">Angular</span>
													</div>
													<!--end::legend-->
												</div>
												<!--end::legends-->
												...
												<div class="d-flex flex-center position-relative">
													<div
														class="font-weight-bolder font-size-h5 text-muted position-absolute">
														8,345</div>
								...
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-6">
											<h3 class="card-title">
												<span
													class="card-label font-weight-bolder font-size-h4 text-dark-75">Total
													Orders</span>
											</h3>
											<div class="card-toolbar">
												<div class="dropdown dropdown-inline" data-toggle="tooltip"
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-6">
											<h3 class="card-title align-items-start flex-column">
												<span
													class="card-label font-weight-bolder font-size-h4 text-dark-75">Top
													Products</span>
										...
										<div class="card-body pt-6">
											...
											<ul class="nav nav-pills nav-fill flex-nowrap">
												...
												<li class="nav-item w-90px">
													<a class="nav-link active d-flex flex-column shadow-sm h-80px"
												...
												<li class="nav-item w-90px mx-5">
													<a class="nav-link d-flex flex-column shadow-sm h-80px"
														data-toggle="tab" href="#kt_tab_mixed_2_2">
														<span class="nav-icon">
															<span class="svg-icon">
																<span class="svg-icon svg-icon-xxl">
												...
												<li class="nav-item w-90px">
													<a class="nav-link d-flex flex-column shadow-sm h-80px"
														data-toggle="tab" href="#kt_tab_mixed_2_3">
														<span class="nav-icon">
															<span class="svg-icon">
																<span class="svg-icon svg-icon-xxl">
											...
											<div class="tab-content mt-9" id="myTabMixed2">
												<!--begin::Tab Pane-->
												<div class="tab-pane fade active show" id="kt_tab_mixed_2_1"
													role="tabpanel" aria-labelledby="kt_tab_mixed_2_1">
													<!--begin::Item-->
													<div class="d-flex align-items-center justify-content-between mb-6">
														...
														<div class="d-flex align-items-center">
															<span
																class="text-muted mr-3 font-size-sm font-weight-bolder">65%</span>
													...
													<div class="d-flex align-items-center justify-content-between mb-6">
														...
														<div class="d-flex align-items-center">
															<span
																class="text-muted mr-3 font-size-sm font-weight-bolder">83%</span>
															<div class="progress progress-xs min-w-65px h-5px">
													...
													<div class="d-flex align-items-center justify-content-between mb-6">
														...
														<div class="d-flex align-items-center">
															<span
																class="text-muted mr-3 font-size-sm font-weight-bolder">47%</span>
															<div class="progress progress-xs min-w-65px h-5px">
																<div class="progress-bar bg-info" role="progressbar"
																	style="width: 47%;" aria-valuenow="50"
																	aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
														<!--end::Progress-->
													...
													<div class="d-flex align-items-center justify-content-between">
														...
														<div class="d-flex align-items-center">
															<span
																class="text-muted mr-3 font-size-sm font-weight-bolder">71%</span>
															<div class="progress progress-xs min-w-65px h-5px">
												...
												<!--end::Tab Pane-->
												<!--begin::Tab Pane-->
												<div class="tab-pane fade" id="kt_tab_mixed_2_2" role="tabpanel"
												...
												<!--end::Tab Pane-->
												<!--begin::Tab Pane-->
												<div class="tab-pane fade" id="kt_tab_mixed_2_3" role="tabpanel"
								...
								<div class="col-lg-8">
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-7">
											<h3 class="card-title align-items-start flex-column">
												<span
													class="card-label font-weight-bolder font-size-h4 text-dark-75">Active
													Companies</span>
												...
												<ul class="nav nav-pills nav-pills-sm nav-dark">
													<li class="nav-item ml-0">
														<a class="nav-link py-2 px-4 font-weight-bolder font-size-sm"
															data-toggle="tab" href="#kt_tab_table_1_1">Pending</a>
													</li>
													<li class="nav-item ml-0">
														<a class="nav-link py-2 px-4 font-weight-bolder font-size-sm"
															data-toggle="tab" href="#kt_tab_table_1_2">Inactive</a>
													</li>
													<li class="nav-item">
														<a class="nav-link py-2 px-4 active font-weight-bolder font-size-sm"
															data-toggle="tab" href="#kt_tab_table_1_3">Active</a>
													</li>
												</ul>
											</div>
										</div>
										...
										<div class="card-body pt-1 pb-4">
											<div class="tab-content mt-5" id="myTabTable1">
												<!--begin::Tap pane-->
												<div class="tab-pane fade" id="kt_tab_table_1_1" role="tabpanel"
														...
														<table class="table table-borderless table-vertical-center">
															...
															<tbody>
																<tr>
																	<td class="py-5 pl-0">
																		<div class="symbol symbol-45 symbol-light mr-2">
																			<span class="symbol-label">
																				<img src="<?php echo base_url('assets/backend/');?>media/svg/misc/003-puzzle.svg"
																	...
																	<td class="pl-0">
																		<a href="#"
																			class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Python
																			Inc.</a>
																		<span
																	...
																	<td class="text-right">
																		<span
																			class="text-muted font-weight-bold d-block">Paid</span>
																		<span
																			class="text-dark-75 font-weight-bolder d-block font-size-lg">$120,000</span>
																	</td>
																	<td class="text-right">
																		<span
																			class="text-muted font-weight-500">AngularJS,
																			C#</span>
																	</td>
																	<td class="text-right">
																		<span
																			class="label label-lg label-light-success label-inline">Approved</span>
																	</td>
																...
																<tr>
																	<td class="py-5 pl-0">
																		<div class="symbol symbol-45 symbol-light mr-2">
																			<span class="symbol-label">
																				<img src="<?php echo base_url('assets/backend/');?>media/svg/misc/005-bebo.svg"
																					class="h-50 align-self-center"
																					alt="" />
																			</span>
																		</div>
																	...
																	<td class="text-right">
																		<span
																			class="text-muted font-weight-bold d-block">Paid</span>
																		<span
																			class="text-dark-75 font-weight-bolder d-block font-size-lg">$28,000</span>
																	</td>
																	<td class="text-right">
																	...
																	<td class="text-right">
																		<span
																			class="label label-lg label-light-primary label-inline">Success</span>
																	</td>
																	<td class="text-right pr-0">
																		<a href="#"
																			class="btn btn-icon btn-light btn-sm">
																...
																<tr>
																	<td class="pt-5 pl-0">
																		<div class="symbol symbol-45 symbol-light mr-2">
																			<span class="symbol-label">
																				<img src="<?php echo base_url('assets/backend/');?>media/svg/misc/014-kickstarter.svg"
																					class="h-50 align-self-center"
																					alt="" />
																			</span>
																		</div>
																	...
																	<td class="pl-0">
																		<a href="#"
																			class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Sass
																			Technologies</a>
																		<span
																			class="text-muted font-weight-bold d-block">Successful
																			Fellas</span>
																	...
																	<td class="text-right">
																		<span
																			class="text-muted font-weight-bold d-block">Paid</span>
																		<span
																			class="text-dark-75 font-weight-bolder d-block font-size-lg">$970,000</span>
																	</td>
																	<td class="text-right">
																		<span
																...
																<tr>
																	<td class="py-5 pl-0">
																		<div class="symbol symbol-45 symbol-light mr-2">
																			<span class="symbol-label">
																				<img src="<?php echo base_url('assets/backend/');?>media/svg/misc/006-plurk.svg"
																					class="h-50 align-self-center"
																					alt="" />
																			</span>
																		</div>
																	...
																	<td class="pl-0 text-left">
																		<a href="#"
																			class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">BP
																			Industries</a>
																		<span
																			class="text-muted font-weight-bold d-block">Successful
																			Fellas</span>
																	...
																	<td class="text-right">
																		<span
																			class="label label-lg label-light-info label-inline">Approved</span>
																	</td>
																	<td class="text-right pr-0">
																		<a href="#"
																			class="btn btn-icon btn-light btn-sm">
																...
																<tr>
																	<td class="pl-0 py-5">
																		<div class="symbol symbol-45 symbol-light mr-2">
																			<span class="symbol-label">
																				<img src="<?php echo base_url('assets/backend/');?>media/svg/misc/015-telegram.svg"
																					class="h-50 align-self-center"
																					alt="" />
																			</span>
																		</div>
																	...
																	<td class="pl-0">
																		<a href="#"
																			class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Automatica</a>
																		<span
																			class="text-muted font-weight-bold d-block">Successful
																			Fellas</span>
																	</td>
																	<td class="text-right">
																		<span
																			class="text-muted font-weight-bold d-block">Paid</span>
																		<span
																			class="text-dark-75 font-weight-bolder d-block font-size-lg">$700,000</span>
																	</td>
																	<td class="text-right">
												...
												<!--end::Tap pane-->
												<!--begin::Tap pane-->
												<div class="tab-pane fade" id="kt_tab_table_1_2" role="tabpanel"
												...
												<!--end::Tap pane-->
												<!--begin::Tap pane-->
												<div class="tab-pane fade show active" id="kt_tab_table_1_3"
													role="tabpanel" aria-labelledby="kt_tab_table_1_3">
													<!--begin::Table-->
													<div class="table-responsive">
														<table class="table table-borderless table-vertical-center">
															<thead>
							...
							<div class="row">
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										<!--begin::Body-->
										<div class="card-body">
											<div id="stats-widget-slider-1" class="carousel slide" data-ride="carousel"
												data-interval="8000">
												<!--begin::Top-->
												<div
													...
													<!--begin::Label-->
													<span
														class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">Announcements</span>
													<!--end::Label-->
													<!--begin::Action-->
													<div class="p-0">
														<a href="#stats-widget-slider-1"
															class="btn btn-icon btn-light btn-sm mr-1" role="button"
															data-slide="prev">
														...
														<a href="#stats-widget-slider-1"
															class="btn btn-icon btn-light btn-sm" role="button"
															data-slide="next">
															<span class="svg-icon svg-icon-md">
												...
												<div class="carousel-inner pt-9">
													...
													<div class="carousel-item">
														...
														<div class="d-flex flex-column justify-content-between h-100">
															<!--begin::Title-->
															<h3
																class="font-size-h4 text-dark-75 text-hover-primary font-weight-bold cursor-pointer">
																AirGreat Presentation</h3>
															<!--end::Title-->
															<!--begin::Text-->
															<p
																class="text-dark-75 font-size-lg font-weight-normal pt-2 mb-0">
										...
										<!--begin::Footer-->
										<div
											class="card-footer border-0 d-flex align-items-center justify-content-between pt-0">
											<!--begin::Label-->
											<span
								...
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										<!--begin::Body-->
										<div class="card-body">
											<div id="stats-widget-slider-2" class="carousel slide" data-ride="carousel"
												data-interval="8000">
												<!--begin::Top-->
												<div
													class="d-flex align-items-center justify-content-between flex-wrap">
													<!--begin::Label-->
													<span
														class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">Projects</span>
													<!--end::Label-->
													<!--begin::Action-->
													<div class="p-0">
														<a href="#stats-widget-slider-2"
															class="btn btn-icon btn-light btn-sm mr-1" role="button"
															data-slide="prev">
															<span class="svg-icon svg-icon-md">
																<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-left.svg-->
										...
										<div class="card-footer border-0 pt-0">
											...
											<div class="flex-grow-1">
												...
												<div class="progress progress-xs bg-light-primary">
													<div class="progress-bar bg-primary" role="progressbar"
														style="width: 70%" aria-valuenow="24" aria-valuemin="0"
														aria-valuemax="100"></div>
												</div>
												<!--end::Progress-->
											</div>
								...
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										<!--begin::Body-->
										<div class="card-body">
											<div id="stats-widget-slider-3" class="carousel slide" data-ride="carousel"
												data-interval="8000">
												<!--begin::Top-->
												<div
													class="d-flex align-items-center justify-content-between flex-wrap">
													<!--begin::Label-->
													<span
														class="font-size-h6 text-muted font-weight-bolder text-uppercase pr-2">Today’s
														Schedule</span>
													<!--end::Label-->
													<!--begin::Action-->
													<div class="p-0">
														<a href="#stats-widget-slider-3"
															class="btn btn-icon btn-light btn-sm mr-1" role="button"
															data-slide="prev">
															<span class="svg-icon svg-icon-md">
																<!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Angle-left.svg-->
												...
												<div class="carousel-inner pt-9">
													...
													<div class="carousel-item">
														...
														<div class="flex-grow-1">
															...
															<!--begin::Text-->
															<p
																class="text-primary font-size-h2 font-weight-bolder pt-3 mb-0">
																11:15AM - 12:30PM</p>
															<!--end::Text-->
														</div>
														<!--end::Section-->
										...
										<table class="table table-borderless table-head-custom table-vertical-center"
											...
											<tbody>
													...
													<td>
														<div class="d-flex flex-column w-100 mr-2">
															...
															<div class="progress progress-xs w-100">
																<div class="progress-bar bg-danger" role="progressbar"
																	style="width: 79%;" aria-valuenow="50"
																	aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</td>
												...
												<tr>
													<td class="pr-0 py-4">
														<div
															class="symbol symbol-45 symbol-light-info flex-shrink-0 mr-5">
															<span
												...
												<tr>
													<td class="pr-0 py-5">
														<div
															class="symbol symbol-45 symbol-light-success flex-shrink-0 mr-5">
															<span
													...
													<td>
														<div class="d-flex flex-column w-100 mr-2">
															...
															<div class="progress progress-xs w-100">
																<div class="progress-bar bg-success" role="progressbar"
																	style="width: 84%;" aria-valuenow="50"
																	aria-valuemin="0" aria-valuemax="100"></div>
															</div>
														</div>
													</td>
												...
												<tr>
													<td class="pr-0 py-4">
														<div
															class="symbol symbol-45 symbol-light-danger flex-shrink-0 mr-3">
															<span
																class="symbol-label font-weight-bolder font-size-lg">JT</span>
														</div>
													</td>
													<td class="pl-0">
														<a href="#"
								...
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-6">
											<h3 class="card-title align-items-start flex-column">
												<span
													class="card-label font-weight-bolder font-size-h4 text-dark-75">Authors
													Progress</span>
													...
													<div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
														...
														<ul class="navi navi-hover navi-active navi-accent">
															...
															<li class="navi-footer pt-5 pb-4">
																<a class="btn btn-light-primary font-weight-bolder btn-sm px-5"
																	href="#">More options</a>
										...
										<div class="card-body pt-5">
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex flex-wrap flex-row-fluid">
													...
													<div class="d-flex flex-column pr-5 flex-grow-1">
														<a href="#"
															class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Marcus
															Smart</a>
													...
													<div class="d-flex align-items-center py-2">
														<!--begin::Label-->
														<span
															class="text-success font-weight-bolder font-size-sm pr-6">+65%</span>
														<!--end::Label-->
														<!--begin::Btn-->
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex flex-wrap flex-row-fluid">
													...
													<div class="d-flex flex-column pr-5 flex-grow-1">
														<a href="#"
															class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Andreas
															Hawks</a>
													...
													<div class="d-flex align-items-center py-2">
														<!--begin::Label-->
														<span
															class="text-success font-weight-bolder font-size-sm pr-6">+23%</span>
														<!--end::Label-->
														<!--begin::Btn-->
														<a href="#" class="btn btn-icon btn-light btn-sm">
															<span class="svg-icon svg-icon-md svg-icon-success">
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex flex-wrap flex-row-fluid">
													...
													<div class="d-flex flex-column pr-5 flex-grow-1">
														<a href="#"
															class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Sarah
															Connor</a>
													...
													<div class="d-flex align-items-center py-2">
														<!--begin::Label-->
														<span
															class="text-danger font-weight-bolder font-size-sm pr-6">-34%</span>
														<!--end::Label-->
														<!--begin::Btn-->
														<a href="#" class="btn btn-icon btn-light btn-sm">
															<span class="svg-icon svg-icon-md svg-icon-success">
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex flex-wrap flex-row-fluid">
													...
													<div class="d-flex flex-column pr-5 flex-grow-1">
														<a href="#"
															class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Amanda
															Harden</a>
														<span class="text-muted font-weight-bold">UI/UX, Art
															Director</span>
													</div>
													...
													<div class="d-flex align-items-center py-2">
														<!--begin::Label-->
														<span
															class="text-success font-weight-bolder font-size-sm pr-6">+72%</span>
														<!--end::Label-->
														<!--begin::Btn-->
														<a href="#" class="btn btn-icon btn-light btn-sm">
															<span class="svg-icon svg-icon-md svg-icon-success">
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex flex-wrap flex-row-fluid">
													...
													<div class="d-flex flex-column pr-5 flex-grow-1">
														<a href="#"
															class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Sean
															Robbins</a>
														<span class="text-muted font-weight-bold">UI/UX, Art
															Director</span>
													</div>
											...
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-wrap flex-row-fluid">
													...
													<div class="d-flex flex-column pr-5 flex-grow-1">
														<a href="#"
															class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Jason
															Tatum</a>
													...
													<div class="d-flex align-items-center py-2">
														<!--begin::Label-->
														<span
															class="text-success font-weight-bolder font-size-sm pr-6">+139%</span>
														<!--end::Label-->
														<!--begin::Btn-->
														<a href="#" class="btn btn-icon btn-light btn-sm">
															<span class="svg-icon svg-icon-md svg-icon-success">
										...
										<div class="card-body pt-7">
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex align-items-center flex-wrap flex-row-fluid">
													...
													<!--begin::Label-->
													<span
														class="text-dark-50 font-weight-bold font-size-lg py-2">$8300</span>
													<!--end::Label-->
												</div>
												<!--end::Content-->
											</div>
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex align-items-center flex-wrap flex-row-fluid">
													...
													<!--begin::Label-->
													<span
														class="text-dark-50 font-weight-bold font-size-lg py-2">$740</span>
													<!--end::Label-->
												</div>
												<!--end::Content-->
											</div>
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex align-items-center flex-wrap flex-row-fluid">
													...
													<!--begin::Label-->
													<span
														class="text-dark-50 font-weight-bold font-size-lg py-2">$92</span>
													<!--end::Label-->
												</div>
												<!--end::Content-->
											</div>
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex align-items-center flex-wrap flex-row-fluid">
													...
													<!--begin::Label-->
													<span
														class="text-dark-50 font-weight-bold font-size-lg py-2">$10,500</span>
													<!--end::Label-->
												</div>
												<!--end::Content-->
											</div>
											...
											<div class="d-flex align-items-center mb-6">
												...
												<div class="d-flex align-items-center flex-wrap flex-row-fluid">
													...
													<!--begin::Label-->
													<span
														class="text-dark-50 font-weight-bold font-size-lg py-2">$204</span>
													<!--end::Label-->
												</div>
												<!--end::Content-->
											</div>
											...
											<div class="d-flex align-items-center">
												...
												<div class="d-flex align-items-center flex-wrap flex-row-fluid">
													...
													<!--begin::Label-->
													<span
														class="text-dark-50 font-weight-bold font-size-lg py-2">$1.270</span>
													<!--end::Label-->
												</div>
												<!--end::Content-->
											</div>
								...
								<div class="col-lg-4">
									...
									<div class="card card-custom card-stretch gutter-b">
										...
										<div class="card-header border-0 pt-7">
											<h3 class="card-title align-items-start flex-column">
												<span
													class="card-label font-weight-bolder font-size-h4 text-dark-75">Audio
													Files</span>
											...
											<div class="card-toolbar">
												<ul class="nav nav-pills nav-pills-sm nav-dark">
													<li class="nav-item ml-0">
														<a class="nav-link py-2 px-4 font-weight-bolder font-size-sm"
															data-toggle="tab" href="#kt_tab_list_3_1">Latest</a>
													</li>
													<li class="nav-item">
														<a class="nav-link py-2 px-4 active font-weight-bolder font-size-sm"
															data-toggle="tab" href="#kt_tab_list_3_2">Popular</a>
													</li>
												</ul>
											</div>
										</div>
										...
										<div class="card-body pt-2">
											<div class="tab-content mt-5" id="myTabList3">
												<!--begin::Tap pane-->
												<div class="tab-pane fade" id="kt_tab_list_3_1" role="tabpanel"
													aria-labelledby="kt_tab_list_3_1">
													<!--begin::Item-->
													<div class="d-flex align-items-center mb-7">
														<!--begin::Btn-->
														<a href="#"
															class="btn btn-icon btn-light-primary font-weight-bold btn-md mr-3">
															<span class="svg-icon svg-icon-xxl">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">AirTicks
																Meeting</a>
														...
														<div class="dropdown dropdown-inline ml-2" data-toggle="tooltip"
															title="Quick actions" data-placement="left">
															<a href="#"
																class="btn btn-icon-primary btn-hover-light-primary btn-sm btn-icon"
																data-toggle="dropdown" aria-haspopup="true"
																aria-expanded="false">
																	...
																	<li class="navi-item">
																		<a href="#" class="navi-link">
																			<span class="navi-text">
																				<span
																					class="label label-xl label-inline label-light-primary">Orders</span>
																			</span>
																		</a>
																	</li>
																	<li class="navi-item">
																		<a href="#" class="navi-link">
																			<span class="navi-text">
																				<span
																					class="label label-xl label-inline label-light-danger">Reports</span>
																			</span>
																		</a>
																	</li>
																	<li class="navi-item">
																		<a href="#" class="navi-link">
																			<span class="navi-text">
																				<span
																					class="label label-xl label-inline label-light-warning">Tasks</span>
																			</span>
																		</a>
																	</li>
																	<li class="navi-item">
																		<a href="#" class="navi-link">
																			<span class="navi-text">
																				<span
																					class="label label-xl label-inline label-light-success">Events</span>
																			</span>
																		</a>
																	</li>
																	<li class="navi-item">
																		<a href="#" class="navi-link">
																			<span class="navi-text">
																				<span
																					class="label label-xl label-inline label-light-dark">Members</span>
																			</span>
																		</a>
																	</li>
																	<li class="navi-separator mt-3 opacity-70"></li>
																	<li class="navi-footer py-4">
																		<a class="btn btn-primary font-weight-bold btn-sm px-5"
																			href="#">
													...
													<div class="d-flex align-items-center mb-7">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">From
																a Distance</a>
													...
													<div class="d-flex align-items-center mb-7">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Space
																Weawer</a>
													...
													<div class="d-flex align-items-center mb-7">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Sunspots</a>
													...
													<div class="d-flex align-items-center mb-7">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Ocean
																Drive</a>
													...
													<div class="d-flex align-items-center">
														...
														<div class="d-flex flex-column flex-grow-1">
															<a href="#"
																class="text-dark text-hover-primary mb-1 font-size-lg font-weight-bolder">Soar,
																Eco</a>
												...
												<!--end::Tap pane-->
												<!--begin::Tap pane-->
												<div class="tab-pane fade show active" id="kt_tab_list_3_2"
													role="tabpanel" aria-labelledby="kt_tab_list_3_2">
													<!--begin::Item-->
													<div class="d-flex align-items-center mb-7">
														<!--begin::Btn-->
														<a href="#"
				...
				<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
						...
						<div class="text-dark order-2 order-md-1">
							...
							<a href="https://keenthemes.com/keen" target="_blank"
		...
		<div class="offcanvas-content">
			...
			<div class="offcanvas-wrapper mb-5 scroll-pull">
				...
				<div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
					...
					<div class="overlay-layer">
						...
						<a href="https://preview.keenthemes.com/keen-v2/demo1/rtl/index.html"
							class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
							target="_blank">RTL</a>
					</div>
				</div>
			...
			<div class="offcanvas-footer">
				<a href="https://themes.getbootstrap.com/product/keen-the-ultimate-bootstrap-admin-theme/"
					target="_blank" class="btn btn-block btn-danger btn-shadow font-weight-bolder text-uppercase">Buy
					Keen Now!</a>
			</div>
			<!--end::Purchase-->
		</div>
